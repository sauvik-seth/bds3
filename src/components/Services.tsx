...
const serviceCards = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format=fit=crop&w=1770&q=80",
  },
  {
    id: 2,
    ...
    <section className="py-28 lg:py-40 bg-gray-100 text-black">
      <div className="container mx-auto px-4">
        <div className="flex justify-center mb-16">
          <h1 className="text-4xl md:text-6xl lg:text-7xl text-center font-extrabold leading-tight">
            Our <span className="text-purple-600">Services</span>
          </h1>
        </div>
        <div ref={containerRef} className="relative h-[400vh]">
          {serviceCards.map((card, i) => {
            const targetScale = 1 - (serviceCards.length - i) * 0.05;
